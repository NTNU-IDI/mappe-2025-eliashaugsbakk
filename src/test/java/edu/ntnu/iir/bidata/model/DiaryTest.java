...
public class DiaryTest {
  ...
  void sortByRatingSortsByRating() {
    ...
    diary.sortByRating(sortedByRating);
  ...
  void filterByAuthorFiltersByAuthor() {
    ...
    diary.filterByAuthor(filteredListByAuthor, "author0");
  ...
  void filterByDestinationFiltersByDestination() {
    ...
    diary.filterByDestination(filteredListByDestination, "dest0");
  ...
  void filterByActivityFiltersByActivity() {
    ...
    diary.filterByActivity(filteredListByActivity, "act0");
  ...
  void filterByTimeIntervalFiltersByTimeInterval() throws InterruptedException {
    ...
    diary.filterByTimeCreated(filteredListByTimeInterval, timeStart, timeStop);
