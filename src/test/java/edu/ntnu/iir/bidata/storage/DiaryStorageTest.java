...
class DiaryStorageTest {
  ...
  void should_PersistEntries_When_WritingAndReadingBack() throws IOException {
    ...
    DiaryEntry entry1 = new DiaryEntry("Auth1", "Dest1", "Act1", 1, "Title1", "Text1");
    DiaryEntry entry2 = new DiaryEntry("Auth2", "Dest2", "Act2", 2, "Title2", "Text2");
    ...
    assertEquals("Title1", readEntries.get("Title1").getTitle(), "First entry title should match.");
